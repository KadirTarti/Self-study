const getCountry = async () => {
  ...
  const data = await res.json(); // artık üstteki linkteki veriler arraye çevrilmiş olarak elimizde
    ...
    document.querySelector("article").innerHTML += `
        <div class="card text-start w-50 shadow-lg bg-light my-4" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <i class="fas fa-lg fa-landmark"></i> ${country.capital}</li>
                
                <li class="list-group-item">
                <i class="fas fa-lg fa-comments"></i> ${country.} </li>

                <li class="list-group-item">
                <i class="fas fa-lg fa-money-bill-wave"></i> ${Object.values(country.currencies)[0].name} ${Object.values(country.currencies)[0].symbol}</li>
                </ul>
            </div>
       </div>
        `;
